...
beforeEach(() => {
  ...
  global.fetch = vi.fn(async (input) => {
    ...
    if (url === "/api/users") return Response.json({ users: [{ id: "u1", name: "NAY", email: "nay@doctype.local", role: "CEO_ADMIN", active: true, mustChangePassword: false, permissions: resolveModulePermissions("CEO_ADMIN", []), lastLoginAt: "2026-08-20T12:00:00Z", sessionActive: true }] });
